...
fun loadTopics(): List<Topic> {
    return listOf(
        ...
        Topic(
            ...
            topicNameResourceId = R.string.photography,
            topicImageResourceId = R.drawable.photography
        ),
        Topic(
            availableCourses = 118,
        ...
        Topic(
            availableCourses = 101,
            topicNameResourceId = R.string.history,
            topicImageResourceId = R.drawable.history
        ),
        Topic(
            availableCourses = 486,
